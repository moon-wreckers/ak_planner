...
int main (int argc, char** argv)
{
    ...
    dubins_distance::dubins_path_sample_many( &path, printConfiguration, 0.1, NULL);
	...
	// while(!rover_simulator.isTrajectoryRecieved())
	// {
	// 	ROS_WARN_ONCE("Waiting for trajectory");
	// }
