 ...
 * Date:	10 Nov, 2017
 *
 * File:	dubins_distance.h
 *
 * Reference & Credits: https://github.com/AndrewWalker/Dubins-Curves
 */

#ifndef _DUBINS_DISTANCE_H_
#define _DUBINS_DISTANCE_H_

#include <ros/ros.h>

namespace dubins_distance
{
	...
	// AM:
	int getDubinsPath( DubinsPath* path, double stepSize, std::vector<std::vector<double> >& path_vector);
	int printDubinsPath( DubinsPath* path, double stepSize);


} // end namespace dubins_distance
